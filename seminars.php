    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">CAREERS</h1>
 		  </div>
		  
        </header>
        <div class="section background-white"> 
          <div class="line">  
            <h2 class="text-size-40 margin-bottom-30">WORKSHOPS AND SEMINARS</h2>
            <hr class="break-small background-primary margin-bottom-30">
<p>&rArr; Dry Needling Therapy.</p>
<p>&rArr; Fascial release and recruitment methods.</p>
<p>&rArr; Instrument assist soft tissue mobilisation.</p>
<p>&rArr; Hypnotherapy.</p>
<p>&rArr; Neurological Rehabilitation.</p>
             </div>
            </div>      
          </div>
        </div> 
