    ...
    <main role="main">
      ...
      <article>
        ...
        <div class="section background-white"> 
          <div class="line">  
            <h2 class="text-size-40 margin-bottom-30">Hypnotherapy</h2>
            <hr class="break-small background-primary margin-bottom-30">
<p>&rArr; Stress release</p>
<p>&rArr; Confident gaining method</p>
<p>&rArr; Self motivation</p>
<p>&rArr; Self hypnosis</p>
<p>&rArr; Improve Concentration</p>
             </div>
            </div>      
          </div>
        </div> 
