    ...
    <main role="main">
      ...
      <article>
        ...
        <div class="section background-white"> 
          <div class="line">  
            <h2 class="text-size-40 margin-bottom-30">CAREERS</h2>
            <hr class="break-small background-primary margin-bottom-30">
 <p>&rArr; Working in the private hospital especially orthopaedic department since 2009.</p>
 <p>&rArr; So our team has been handling various type of orthopaedic problems with physiotherapy oriented.</p>
             </div>
            </div>      
          </div>
        </div> 
