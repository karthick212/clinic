    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
<h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">SUPPORT & SERVICES</h1>
 		  </div>
		  
        </header>
        <div class="section background-white"> 
          <div class="line">  
            <h2 class="text-size-40 margin-bottom-30">Orthopaedic Rehabilitation</h2>
            <hr class="break-small background-primary margin-bottom-30">
 <p>&rArr; Post Traumatic Care.</p>
  <p>&rArr; Post Operative Care.</p>
  <p>&rArr; Ligament Injuries.</p>
  <p>&rArr; Total Knee Replacement Care.</p>
  <p>&rArr; Total Hip Replacement Care.</p>
             </div>
            </div>      
          </div>
        </div> 
